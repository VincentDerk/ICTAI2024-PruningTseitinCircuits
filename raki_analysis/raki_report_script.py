...
def _get_marker(instance_path):
    if "/gnb/gnb_" in instance_path:
        return "o"
    elif "/smokers/smokers_" in instance_path:
        return "x"
    elif "/gh/gh_" in instance_path:
        return "s"
    elif "/lp2sat/smokers_" in instance_path:
        return "v"
    elif "/lp2sat/tree_" in instance_path:
        return "^"
    elif "/tree/tree_" in instance_path:
        return "<"
    else:
        return "."
...
if __name__ == "__main__":
    ...
    _scatter_reg_vs_tseitin(results, "./results/raki_exp_reg_vs_tseitin.pdf")
    print("")
    print("prop vs tseitin")
    _scatter_prop_vs_tseitin(results, "./results/raki_exp_prop_vs_tseitin.pdf")
