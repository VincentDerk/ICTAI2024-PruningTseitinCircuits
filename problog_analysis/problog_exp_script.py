...
if __name__ == "__main__":
    ...
    execute_experiment(result_path, "../sources/problog_src/gossip-networks/", add_query=False)
    ...
    # _process(result_path, "../sources/problog_src/games/biased_coin_toss1_100.pl", add_query=False)
