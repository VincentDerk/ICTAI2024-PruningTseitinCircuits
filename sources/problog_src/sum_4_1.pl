...
0.1::digit(4,0) ; 0.1::digit(4,1) ; 0.1::digit(4,2) ; 0.1::digit(4,3) ; 0.1::digit(4,4) ; 0.1::digit(4,5) ; 0.1::digit(4,6) ; 0.1::digit(4,7) ; 0.1::digit(1,8) ; 0.1::digit(4,9).

sum([A,B,C,D], E) :- digit(1,A), digit(2,B), digit(3,C), digit(4,D), E is A+B+C+D.

query(sum([A,B,C,D], 12)).