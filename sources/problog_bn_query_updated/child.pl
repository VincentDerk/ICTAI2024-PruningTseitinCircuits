%% ProbLog program: PGM 31
%% Created on 2024-03-30 00:23:02.507761
...
0.8::lungParench("Normal"); 0.05::lungParench("Congested"); 0.15::lungParench("Abnormal") :- (disease("PAIVS"); disease("TGA"); disease("Fallot")).
0.6::lungParench("Normal"); 0.1::lungParench("Congested"); 0.3::lungParench("Abnormal") :- disease("PFC").
0.7::sick :- (disease("TAPVD"); disease("Lung")).
0.2::sick :- disease("Fallot").
0.3::sick :- (disease("TGA"); disease("PAIVS")).
0.4::sick :- disease("PFC").
0.05::lVH :- disease("TAPVD").
0.9::lVH :- disease("PAIVS").
0.1::lVH :- (disease("TGA"); disease("PFC"); disease("Lung"); disease("Fallot")).
...
0.8::ductFlow("Lt_to_Rt"); 0.2::ductFlow("None") :- disease("Fallot").
ductFlow("Lt_to_Rt") :- disease("PAIVS").
...
0.02::hypoxiaInO2("Mild"); 0.18::hypoxiaInO2("Moderate"); 0.8::hypoxiaInO2("Severe") :- cardiacMixing("Transp."), \+lungParench("Congested").
...
0.05::hypDistrib :- ductFlow("Rt_to_Lt"), cardiacMixing("Complete").
0.5::hypDistrib :- ductFlow("Rt_to_Lt"), (cardiacMixing("Mild"); cardiacMixing("Transp.")).
0.95::hypDistrib :- ductFlow("Rt_to_Lt"), cardiacMixing("None").
0.05::hypDistrib :- ductFlow("None").
0.05::hypDistrib :- ductFlow("Lt_to_Rt").
...
0.8::age("0-3_days"); 0.15::age("4-10_days"); 0.05::age("11-30_days") :- disease("PAIVS").
...
0.1::lowerBodyO2("<5"); 0.3::lowerBodyO2("5-12"); 0.6::lowerBodyO2("12+") :- \+hypDistrib, hypoxiaInO2("Mild").
0.3::lowerBodyO2("<5"); 0.6::lowerBodyO2("5-12"); 0.1::lowerBodyO2("12+") :- \+hypDistrib, hypoxiaInO2("Moderate").
0.5::lowerBodyO2("<5"); 0.4::lowerBodyO2("5-12"); 0.1::lowerBodyO2("12+") :- \+hypDistrib, hypoxiaInO2("Severe").
0.4::lowerBodyO2("<5"); 0.5::lowerBodyO2("5-12"); 0.1::lowerBodyO2("12+") :- hypDistrib, hypoxiaInO2("Mild").
0.5::lowerBodyO2("<5"); 0.45::lowerBodyO2("5-12"); 0.05::lowerBodyO2("12+") :- hypDistrib, hypoxiaInO2("Moderate").
0.6::lowerBodyO2("<5"); 0.35::lowerBodyO2("5-12"); 0.05::lowerBodyO2("12+") :- hypDistrib, hypoxiaInO2("Severe").
...
0.9::cO2Report :- cO2("High").
0.1::cO2Report :- \+cO2("High").
