%% ProbLog program: PGM 47
%% Created on 2024-03-30 00:25:07.469696
query(bP("LOW")).
0.2::hYPOVOLEMIA.
0.1::iNSUFFANESTH.
0.95::fIO2.
...
0.95::sHUNT :- iNTUBATION("ONESIDED"), \+pULMEMBOLUS.
0.05::sHUNT :- \+iNTUBATION("ONESIDED"), \+pULMEMBOLUS.
0.99::sHUNT :- iNTUBATION("ONESIDED"), pULMEMBOLUS.
0.9::sHUNT :- \+iNTUBATION("ONESIDED"), pULMEMBOLUS.
...
0.97::vENTTUBE("ZERO"); 0.01::vENTTUBE("LOW"); 0.01::vENTTUBE("NORMAL"); 0.01::vENTTUBE("HIGH") :- vENTMACH("LOW").
0.97::vENTTUBE("ZERO"); 0.01::vENTTUBE("LOW"); 0.01::vENTTUBE("NORMAL"); 0.01::vENTTUBE("HIGH") :- vENTMACH("ZERO").
...
0.01::pRESS("ZERO"); 0.01::pRESS("LOW"); 0.01::pRESS("NORMAL"); 0.97::pRESS("HIGH") :- iNTUBATION("ONESIDED"), \+kINKEDTUBE, (vENTTUBE("HIGH"); vENTTUBE("LOW")).
...
0.97::pRESS("ZERO"); 0.01::pRESS("LOW"); 0.01::pRESS("NORMAL"); 0.01::pRESS("HIGH") :- iNTUBATION("ESOPHAGEAL"), \+kINKEDTUBE, (vENTTUBE("ZERO"); vENTTUBE("NORMAL")).
...
0.01::pRESS("ZERO"); 0.01::pRESS("LOW"); 0.01::pRESS("NORMAL"); 0.97::pRESS("HIGH") :- iNTUBATION("NORMAL"), \+kINKEDTUBE, (vENTTUBE("ZERO"); vENTTUBE("NORMAL")).
0.01::pRESS("ZERO"); 0.01::pRESS("LOW"); 0.97::pRESS("NORMAL"); 0.01::pRESS("HIGH") :- iNTUBATION("ONESIDED"), kINKEDTUBE, vENTTUBE("NORMAL").
0.97::pRESS("ZERO"); 0.01::pRESS("LOW"); 0.01::pRESS("NORMAL"); 0.01::pRESS("HIGH") :- iNTUBATION("ONESIDED"), kINKEDTUBE, (vENTTUBE("HIGH"); vENTTUBE("LOW")).
...
0.97::pRESS("ZERO"); 0.01::pRESS("LOW"); 0.01::pRESS("NORMAL"); 0.01::pRESS("HIGH") :- iNTUBATION("NORMAL"), kINKEDTUBE, (vENTTUBE("ZERO"); vENTTUBE("NORMAL")).
...
0.97::vENTLUNG("ZERO"); 0.01::vENTLUNG("LOW"); 0.01::vENTLUNG("NORMAL"); 0.01::vENTLUNG("HIGH") :- kINKEDTUBE, vENTTUBE("HIGH").
...
0.97::vENTLUNG("ZERO"); 0.01::vENTLUNG("LOW"); 0.01::vENTLUNG("NORMAL"); 0.01::vENTLUNG("HIGH") :- kINKEDTUBE, vENTTUBE("LOW").
...
0.5::mINVOL("ZERO"); 0.48::mINVOL("LOW"); 0.01::mINVOL("NORMAL"); 0.01::mINVOL("HIGH") :- \+iNTUBATION("ONESIDED"), vENTLUNG("NORMAL").
...
0.01::pVSAT("LOW"); 0.95::pVSAT("NORMAL"); 0.04::pVSAT("HIGH") :- \+fIO2, vENTALV("HIGH").
0.01::pVSAT("LOW"); 0.01::pVSAT("NORMAL"); 0.98::pVSAT("HIGH") :- fIO2, vENTALV("HIGH").
pVSAT("LOW") :- \+fIO2, vENTALV("NORMAL").
0.95::pVSAT("LOW"); 0.04::pVSAT("NORMAL"); 0.01::pVSAT("HIGH") :- fIO2, vENTALV("NORMAL").
0.95::pVSAT("LOW"); 0.04::pVSAT("NORMAL"); 0.01::pVSAT("HIGH") :- vENTALV("LOW").
pVSAT("LOW") :- \+fIO2, vENTALV("ZERO").
0.99::pVSAT("LOW"); 0.01::pVSAT("NORMAL") :- fIO2, vENTALV("ZERO").
...
0.01::aRTCO2("LOW"); 0.01::aRTCO2("NORMAL"); 0.98::aRTCO2("HIGH") :- (vENTALV("LOW"); vENTALV("ZERO")).
0.01::eXPCO2("ZERO"); 0.01::eXPCO2("LOW"); 0.01::eXPCO2("NORMAL"); 0.97::eXPCO2("HIGH") :- vENTLUNG("HIGH").
0.97::eXPCO2("ZERO"); 0.01::eXPCO2("LOW"); 0.01::eXPCO2("NORMAL"); 0.01::eXPCO2("HIGH") :- aRTCO2("HIGH"), vENTLUNG("NORMAL").
0.01::eXPCO2("ZERO"); 0.01::eXPCO2("LOW"); 0.97::eXPCO2("NORMAL"); 0.01::eXPCO2("HIGH") :- \+aRTCO2("HIGH"), vENTLUNG("NORMAL").
...
0.01::eXPCO2("ZERO"); 0.97::eXPCO2("LOW"); 0.01::eXPCO2("NORMAL"); 0.01::eXPCO2("HIGH") :- \+aRTCO2("LOW"), vENTLUNG("ZERO").
0.97::eXPCO2("ZERO"); 0.01::eXPCO2("LOW"); 0.01::eXPCO2("NORMAL"); 0.01::eXPCO2("HIGH") :- aRTCO2("LOW"), vENTLUNG("ZERO").
0.01::sAO2("LOW"); 0.01::sAO2("NORMAL"); 0.98::sAO2("HIGH") :- pVSAT("HIGH"), \+sHUNT.
0.69::sAO2("LOW"); 0.3::sAO2("NORMAL"); 0.01::sAO2("HIGH") :- pVSAT("HIGH"), sHUNT.
0.01::sAO2("LOW"); 0.98::sAO2("NORMAL"); 0.01::sAO2("HIGH") :- pVSAT("NORMAL"), \+sHUNT.
0.98::sAO2("LOW"); 0.01::sAO2("NORMAL"); 0.01::sAO2("HIGH") :- pVSAT("NORMAL"), sHUNT.
0.98::sAO2("LOW"); 0.01::sAO2("NORMAL"); 0.01::sAO2("HIGH") :- pVSAT("LOW").
0.7::cATECHOL :- aRTCO2("HIGH"), sAO2("HIGH"), tPR("HIGH").
0.7::cATECHOL :- aRTCO2("HIGH"), \+iNSUFFANESTH, sAO2("NORMAL"), tPR("HIGH").
0.9::cATECHOL :- aRTCO2("HIGH"), iNSUFFANESTH, sAO2("NORMAL"), tPR("HIGH").
0.9::cATECHOL :- aRTCO2("HIGH"), sAO2("LOW"), tPR("HIGH").
0.01::cATECHOL :- aRTCO2("NORMAL"), sAO2("HIGH"), tPR("HIGH").
0.3::cATECHOL :- aRTCO2("NORMAL"), iNSUFFANESTH, sAO2("NORMAL"), tPR("HIGH").
0.01::cATECHOL :- aRTCO2("NORMAL"), \+iNSUFFANESTH, sAO2("NORMAL"), tPR("HIGH").
0.3::cATECHOL :- aRTCO2("NORMAL"), sAO2("LOW"), tPR("HIGH").
0.05::cATECHOL :- aRTCO2("LOW"), sAO2("HIGH"), tPR("HIGH").
0.05::cATECHOL :- aRTCO2("LOW"), \+iNSUFFANESTH, sAO2("NORMAL"), tPR("HIGH").
0.3::cATECHOL :- aRTCO2("LOW"), iNSUFFANESTH, sAO2("NORMAL"), tPR("HIGH").
0.3::cATECHOL :- aRTCO2("LOW"), sAO2("LOW"), tPR("HIGH").
0.99::cATECHOL :- aRTCO2("HIGH"), tPR("NORMAL").
0.95::cATECHOL :- \+aRTCO2("HIGH"), \+sAO2("LOW"), tPR("NORMAL").
0.99::cATECHOL :- \+aRTCO2("HIGH"), iNSUFFANESTH, sAO2("LOW"), tPR("NORMAL").
0.95::cATECHOL :- \+aRTCO2("HIGH"), \+iNSUFFANESTH, sAO2("LOW"), tPR("NORMAL").
0.99::cATECHOL :- aRTCO2("HIGH"), \+iNSUFFANESTH, sAO2("HIGH"), tPR("LOW").
0.95::cATECHOL :- \+aRTCO2("HIGH"), \+iNSUFFANESTH, sAO2("HIGH"), tPR("LOW").
0.99::cATECHOL :- iNSUFFANESTH, sAO2("HIGH"), tPR("LOW").
0.99::cATECHOL :- \+sAO2("HIGH"), tPR("LOW").
0.05::hR("LOW"); 0.9::hR("NORMAL"); 0.05::hR("HIGH") :- \+cATECHOL.
0.01::hR("LOW"); 0.09::hR("NORMAL"); 0.9::hR("HIGH") :- cATECHOL.
...
0.3333333::hREKG("LOW"); 0.3333333::hREKG("NORMAL"); 0.3333333::hREKG("HIGH") :- hR("LOW").
...
0.3333333::hRSAT("LOW"); 0.3333333::hRSAT("NORMAL"); 0.3333333::hRSAT("HIGH") :- hR("LOW").
...
0.98::bP("LOW"); 0.01::bP("NORMAL"); 0.01::bP("HIGH") :- cO("LOW"), \+tPR("HIGH").
