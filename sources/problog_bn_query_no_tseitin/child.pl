...
%% Created on 2024-03-29 23:59:57.866800
...
0.9::lVHreport :- lVH.
0.05::lVHreport :- \+lVH.
0.05::hypDistrib :- ductFlow("Lt_to_Rt"), cardiacMixing("None").
0.05::hypDistrib :- ductFlow("Lt_to_Rt"), cardiacMixing("Mild").
0.05::hypDistrib :- ductFlow("Lt_to_Rt"), cardiacMixing("Complete").
0.05::hypDistrib :- ductFlow("Lt_to_Rt"), cardiacMixing("Transp.").
0.05::hypDistrib :- ductFlow("None"), cardiacMixing("None").
0.05::hypDistrib :- ductFlow("None"), cardiacMixing("Mild").
0.05::hypDistrib :- ductFlow("None"), cardiacMixing("Complete").
0.05::hypDistrib :- ductFlow("None"), cardiacMixing("Transp.").
0.95::hypDistrib :- ductFlow("Rt_to_Lt"), cardiacMixing("None").
0.5::hypDistrib :- ductFlow("Rt_to_Lt"), cardiacMixing("Mild").
0.05::hypDistrib :- ductFlow("Rt_to_Lt"), cardiacMixing("Complete").
0.5::hypDistrib :- ductFlow("Rt_to_Lt"), cardiacMixing("Transp.").
...
0.1::cO2Report :- cO2("Normal").
0.1::cO2Report :- cO2("Low").
