...
%% Created on 2024-03-29 23:54:16.521018
query(r5Fcst("SVR")).
...
scenRel3_4("ACEFK") :- scenario("A").
scenRel3_4("B") :- scenario("B").
scenRel3_4("ACEFK") :- scenario("C").
scenRel3_4("D") :- scenario("D").
scenRel3_4("ACEFK") :- scenario("E").
scenRel3_4("ACEFK") :- scenario("F").
scenRel3_4("GJ") :- scenario("G").
scenRel3_4("HI") :- scenario("H").
scenRel3_4("HI") :- scenario("I").
scenRel3_4("GJ") :- scenario("J").
scenRel3_4("ACEFK") :- scenario("K").
0.2::windFieldMt :- scenario("A").
0.65::windFieldMt :- scenario("B").
0.25::windFieldMt :- scenario("C").
0.3::windFieldMt :- scenario("D").
0.35::windFieldMt :- scenario("E").
0.85::windFieldMt :- scenario("F").
0.3::windFieldMt :- scenario("G").
0.7::windFieldMt :- scenario("H").
0.5::windFieldMt :- scenario("I").
0.99::windFieldMt :- scenario("J").
0.3::windFieldMt :- scenario("K").
scenRelAMIns("ABI") :- scenario("A").
scenRelAMIns("ABI") :- scenario("B").
scenRelAMIns("CDEJ") :- scenario("C").
scenRelAMIns("CDEJ") :- scenario("D").
scenRelAMIns("CDEJ") :- scenario("E").
scenRelAMIns("F") :- scenario("F").
scenRelAMIns("G") :- scenario("G").
scenRelAMIns("H") :- scenario("H").
scenRelAMIns("ABI") :- scenario("I").
scenRelAMIns("CDEJ") :- scenario("J").
...
\+scenRelAMCIN :- scenario("A").
\+scenRelAMCIN :- scenario("B").
scenRelAMCIN :- scenario("C").
scenRelAMCIN :- scenario("D").
scenRelAMCIN :- scenario("E").
scenRelAMCIN :- scenario("F").
scenRelAMCIN :- scenario("G").
scenRelAMCIN :- scenario("H").
scenRelAMCIN :- scenario("I").
scenRelAMCIN :- scenario("J").
scenRelAMCIN :- scenario("K").
...
insInMt("Strong") :- cldShadeOth("PC"), aMInstabMt("Strong").
...
insInMt("Strong") :- cldShadeOth("Clear"), aMInstabMt("Strong").
...
outflowFrMt("None") :- insInMt("None"), wndHodograph("DCVZFavor").
outflowFrMt("None") :- insInMt("None"), wndHodograph("StrongWest").
outflowFrMt("None") :- insInMt("None"), wndHodograph("Westerly").
outflowFrMt("None") :- insInMt("None"), wndHodograph("Other").
...
cldShadeConv("None") :- insInMt("None"), wndHodograph("DCVZFavor").
cldShadeConv("None") :- insInMt("None"), wndHodograph("StrongWest").
cldShadeConv("None") :- insInMt("None"), wndHodograph("Westerly").
cldShadeConv("None") :- insInMt("None"), wndHodograph("Other").
...
0.4::boundaries("Weak"); 0.6::boundaries("Strong") :- outflowFrMt("Strong"), wndHodograph("DCVZFavor"), morningBound("Weak").
...
0.4::boundaries("Weak"); 0.6::boundaries("Strong") :- outflowFrMt("Strong"), wndHodograph("StrongWest"), morningBound("Weak").
0.2::boundaries("Weak"); 0.8::boundaries("Strong") :- outflowFrMt("Strong"), wndHodograph("StrongWest"), morningBound("Strong").
...
0.2::boundaries("Weak"); 0.8::boundaries("Strong") :- outflowFrMt("Strong"), wndHodograph("Westerly"), morningBound("Strong").
...
r5Fcst("SIG") :- mountainFcst("SIG"), n34StarFcst("XNIL").
r5Fcst("SIG") :- mountainFcst("SIG"), n34StarFcst("SIG").
r5Fcst("SVR") :- mountainFcst("SIG"), n34StarFcst("SVR").
r5Fcst("SVR") :- mountainFcst("SVR"), n34StarFcst("XNIL").
r5Fcst("SVR") :- mountainFcst("SVR"), n34StarFcst("SIG").
r5Fcst("SVR") :- mountainFcst("SVR"), n34StarFcst("SVR").
