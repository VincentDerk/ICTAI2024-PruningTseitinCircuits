%% ProbLog program: PGM 25
%% Created on 2024-03-30 00:01:51.413769
...
\+goodStudent :- socioEcon("Prole"), age("Adult").
\+goodStudent :- socioEcon("Prole"), age("Senior").
0.2::goodStudent :- socioEcon("Middle"), age("Adolescent").
\+goodStudent :- socioEcon("Middle"), age("Adult").
\+goodStudent :- socioEcon("Middle"), age("Senior").
0.5::goodStudent :- socioEcon("UpperMiddle"), age("Adolescent").
\+goodStudent :- socioEcon("UpperMiddle"), age("Adult").
\+goodStudent :- socioEcon("UpperMiddle"), age("Senior").
0.4::goodStudent :- socioEcon("Wealthy"), age("Adolescent").
\+goodStudent :- socioEcon("Wealthy"), age("Adult").
\+goodStudent :- socioEcon("Wealthy"), age("Senior").
...
0.85::vehicleYear :- socioEcon("Prole"), riskAversion("Psychopath").
0.85::vehicleYear :- socioEcon("Prole"), riskAversion("Adventurous").
0.85::vehicleYear :- socioEcon("Prole"), riskAversion("Normal").
0.85::vehicleYear :- socioEcon("Prole"), riskAversion("Cautious").
0.7::vehicleYear :- socioEcon("Middle"), riskAversion("Psychopath").
0.7::vehicleYear :- socioEcon("Middle"), riskAversion("Adventurous").
0.7::vehicleYear :- socioEcon("Middle"), riskAversion("Normal").
0.7::vehicleYear :- socioEcon("Middle"), riskAversion("Cautious").
0.2::vehicleYear :- socioEcon("UpperMiddle"), riskAversion("Psychopath").
0.2::vehicleYear :- socioEcon("UpperMiddle"), riskAversion("Adventurous").
0.2::vehicleYear :- socioEcon("UpperMiddle"), riskAversion("Normal").
0.2::vehicleYear :- socioEcon("UpperMiddle"), riskAversion("Cautious").
0.1::vehicleYear :- socioEcon("Wealthy"), riskAversion("Psychopath").
0.1::vehicleYear :- socioEcon("Wealthy"), riskAversion("Adventurous").
0.1::vehicleYear :- socioEcon("Wealthy"), riskAversion("Normal").
0.1::vehicleYear :- socioEcon("Wealthy"), riskAversion("Cautious").
\+seniorTrain :- age("Adolescent"), riskAversion("Psychopath").
\+seniorTrain :- age("Adolescent"), riskAversion("Adventurous").
\+seniorTrain :- age("Adolescent"), riskAversion("Normal").
\+seniorTrain :- age("Adolescent"), riskAversion("Cautious").
\+seniorTrain :- age("Adult"), riskAversion("Psychopath").
\+seniorTrain :- age("Adult"), riskAversion("Adventurous").
\+seniorTrain :- age("Adult"), riskAversion("Normal").
\+seniorTrain :- age("Adult"), riskAversion("Cautious").
...
0.1::makeModel("SportsCar"); 0.7::makeModel("Economy"); 0.2::makeModel("FamilySedan") :- socioEcon("Prole"), riskAversion("Psychopath").
0.1::makeModel("SportsCar"); 0.7::makeModel("Economy"); 0.2::makeModel("FamilySedan") :- socioEcon("Prole"), riskAversion("Adventurous").
0.1::makeModel("SportsCar"); 0.7::makeModel("Economy"); 0.2::makeModel("FamilySedan") :- socioEcon("Prole"), riskAversion("Normal").
0.1::makeModel("SportsCar"); 0.7::makeModel("Economy"); 0.2::makeModel("FamilySedan") :- socioEcon("Prole"), riskAversion("Cautious").
0.15::makeModel("SportsCar"); 0.2::makeModel("Economy"); 0.65::makeModel("FamilySedan") :- socioEcon("Middle"), riskAversion("Psychopath").
0.15::makeModel("SportsCar"); 0.2::makeModel("Economy"); 0.65::makeModel("FamilySedan") :- socioEcon("Middle"), riskAversion("Adventurous").
0.15::makeModel("SportsCar"); 0.2::makeModel("Economy"); 0.65::makeModel("FamilySedan") :- socioEcon("Middle"), riskAversion("Normal").
0.15::makeModel("SportsCar"); 0.2::makeModel("Economy"); 0.65::makeModel("FamilySedan") :- socioEcon("Middle"), riskAversion("Cautious").
0.2::makeModel("SportsCar"); 0.05::makeModel("Economy"); 0.3::makeModel("FamilySedan"); 0.45::makeModel("Luxury") :- socioEcon("UpperMiddle"), riskAversion("Psychopath").
0.2::makeModel("SportsCar"); 0.05::makeModel("Economy"); 0.3::makeModel("FamilySedan"); 0.45::makeModel("Luxury") :- socioEcon("UpperMiddle"), riskAversion("Adventurous").
0.2::makeModel("SportsCar"); 0.05::makeModel("Economy"); 0.3::makeModel("FamilySedan"); 0.45::makeModel("Luxury") :- socioEcon("UpperMiddle"), riskAversion("Normal").
0.2::makeModel("SportsCar"); 0.05::makeModel("Economy"); 0.3::makeModel("FamilySedan"); 0.45::makeModel("Luxury") :- socioEcon("UpperMiddle"), riskAversion("Cautious").
...
airbag :- makeModel("SportsCar"), \+vehicleYear.
0.1::airbag :- makeModel("SportsCar"), vehicleYear.
airbag :- makeModel("Economy"), \+vehicleYear.
0.05::airbag :- makeModel("Economy"), vehicleYear.
airbag :- makeModel("FamilySedan"), \+vehicleYear.
0.2::airbag :- makeModel("FamilySedan"), vehicleYear.
airbag :- makeModel("Luxury"), \+vehicleYear.
0.6::airbag :- makeModel("Luxury"), vehicleYear.
airbag :- makeModel("SuperLuxury"), \+vehicleYear.
0.1::airbag :- makeModel("SuperLuxury"), vehicleYear.
...
\+antilock :- makeModel("Economy"), vehicleYear.
0.4::antilock :- makeModel("FamilySedan"), \+vehicleYear.
\+antilock :- makeModel("FamilySedan"), vehicleYear.
0.99::antilock :- makeModel("Luxury"), \+vehicleYear.
0.3::antilock :- makeModel("Luxury"), vehicleYear.
0.99::antilock :- makeModel("SuperLuxury"), \+vehicleYear.
0.15::antilock :- makeModel("SuperLuxury"), vehicleYear.
0.1::carValue("TenThou"); 0.8::carValue("TwentyThou"); 0.09::carValue("FiftyThou"); 0.01::carValue("Million") :- makeModel("SportsCar"), \+vehicleYear, mileage("FiveThou").
0.1::carValue("TenThou"); 0.8::carValue("TwentyThou"); 0.09::carValue("FiftyThou"); 0.01::carValue("Million") :- makeModel("SportsCar"), \+vehicleYear, mileage("TwentyThou").
0.1::carValue("TenThou"); 0.8::carValue("TwentyThou"); 0.09::carValue("FiftyThou"); 0.01::carValue("Million") :- makeModel("SportsCar"), \+vehicleYear, mileage("FiftyThou").
0.1::carValue("TenThou"); 0.8::carValue("TwentyThou"); 0.09::carValue("FiftyThou"); 0.01::carValue("Million") :- makeModel("SportsCar"), \+vehicleYear, mileage("Domino").
...
0.1::carValue("FiveThou"); 0.8::carValue("TenThou"); 0.1::carValue("TwentyThou") :- makeModel("Economy"), \+vehicleYear, mileage("FiveThou").
0.1::carValue("FiveThou"); 0.8::carValue("TenThou"); 0.1::carValue("TwentyThou") :- makeModel("Economy"), \+vehicleYear, mileage("TwentyThou").
0.1::carValue("FiveThou"); 0.8::carValue("TenThou"); 0.1::carValue("TwentyThou") :- makeModel("Economy"), \+vehicleYear, mileage("FiftyThou").
0.1::carValue("FiveThou"); 0.8::carValue("TenThou"); 0.1::carValue("TwentyThou") :- makeModel("Economy"), \+vehicleYear, mileage("Domino").
...
0.1::carValue("TenThou"); 0.9::carValue("TwentyThou") :- makeModel("FamilySedan"), \+vehicleYear, mileage("FiveThou").
0.1::carValue("TenThou"); 0.9::carValue("TwentyThou") :- makeModel("FamilySedan"), \+vehicleYear, mileage("TwentyThou").
0.1::carValue("TenThou"); 0.9::carValue("TwentyThou") :- makeModel("FamilySedan"), \+vehicleYear, mileage("FiftyThou").
0.1::carValue("TenThou"); 0.9::carValue("TwentyThou") :- makeModel("FamilySedan"), \+vehicleYear, mileage("Domino").
...
carValue("FiftyThou") :- makeModel("Luxury"), \+vehicleYear, mileage("FiveThou").
carValue("FiftyThou") :- makeModel("Luxury"), \+vehicleYear, mileage("TwentyThou").
carValue("FiftyThou") :- makeModel("Luxury"), \+vehicleYear, mileage("FiftyThou").
carValue("FiftyThou") :- makeModel("Luxury"), \+vehicleYear, mileage("Domino").
...
carValue("Million") :- makeModel("SuperLuxury"), \+vehicleYear, mileage("FiveThou").
carValue("Million") :- makeModel("SuperLuxury"), \+vehicleYear, mileage("TwentyThou").
carValue("Million") :- makeModel("SuperLuxury"), \+vehicleYear, mileage("FiftyThou").
carValue("Million") :- makeModel("SuperLuxury"), \+vehicleYear, mileage("Domino").
1e-06::carValue("FiveThou"); 1e-06::carValue("TenThou"); 1e-06::carValue("TwentyThou"); 1e-06::carValue("FiftyThou"); 0.999996::carValue("Million") :- makeModel("SuperLuxury"), vehicleYear, mileage("FiveThou").
1e-06::carValue("FiveThou"); 1e-06::carValue("TenThou"); 1e-06::carValue("TwentyThou"); 1e-06::carValue("FiftyThou"); 0.999996::carValue("Million") :- makeModel("SuperLuxury"), vehicleYear, mileage("TwentyThou").
1e-06::carValue("FiveThou"); 1e-06::carValue("TenThou"); 1e-06::carValue("TwentyThou"); 1e-06::carValue("FiftyThou"); 0.999996::carValue("Million") :- makeModel("SuperLuxury"), vehicleYear, mileage("FiftyThou").
1e-06::carValue("FiveThou"); 1e-06::carValue("TenThou"); 1e-06::carValue("TwentyThou"); 1e-06::carValue("FiftyThou"); 0.999996::carValue("Million") :- makeModel("SuperLuxury"), vehicleYear, mileage("Domino").
0.95::ruggedAuto("EggShell"); 0.04::ruggedAuto("Football"); 0.01::ruggedAuto("Tank") :- makeModel("SportsCar"), \+vehicleYear.
0.95::ruggedAuto("EggShell"); 0.04::ruggedAuto("Football"); 0.01::ruggedAuto("Tank") :- makeModel("SportsCar"), vehicleYear.
...
0.1::ruggedAuto("EggShell"); 0.6::ruggedAuto("Football"); 0.3::ruggedAuto("Tank") :- makeModel("Luxury"), \+vehicleYear.
0.1::ruggedAuto("EggShell"); 0.6::ruggedAuto("Football"); 0.3::ruggedAuto("Tank") :- makeModel("Luxury"), vehicleYear.
0.05::ruggedAuto("EggShell"); 0.55::ruggedAuto("Football"); 0.4::ruggedAuto("Tank") :- makeModel("SuperLuxury"), \+vehicleYear.
0.05::ruggedAuto("EggShell"); 0.55::ruggedAuto("Football"); 0.4::ruggedAuto("Tank") :- makeModel("SuperLuxury"), vehicleYear.
drivQuality("Poor") :- drivingSkill("SubStandard"), riskAversion("Psychopath").
drivQuality("Poor") :- drivingSkill("SubStandard"), riskAversion("Adventurous").
drivQuality("Poor") :- drivingSkill("SubStandard"), riskAversion("Normal").
drivQuality("Poor") :- drivingSkill("SubStandard"), riskAversion("Cautious").
...
drivQuality("Excellent") :- drivingSkill("Expert"), riskAversion("Normal").
drivQuality("Excellent") :- drivingSkill("Expert"), riskAversion("Cautious").
...
otherCarCost("Thousand") :- accident("None"), ruggedAuto("EggShell").
otherCarCost("Thousand") :- accident("None"), ruggedAuto("Football").
otherCarCost("Thousand") :- accident("None"), ruggedAuto("Tank").
...
medCost("Thousand") :- accident("None"), age("Adolescent"), cushioning("Poor").
medCost("Thousand") :- accident("None"), age("Adolescent"), cushioning("Fair").
medCost("Thousand") :- accident("None"), age("Adolescent"), cushioning("Good").
medCost("Thousand") :- accident("None"), age("Adolescent"), cushioning("Excellent").
medCost("Thousand") :- accident("None"), age("Adult"), cushioning("Poor").
medCost("Thousand") :- accident("None"), age("Adult"), cushioning("Fair").
medCost("Thousand") :- accident("None"), age("Adult"), cushioning("Good").
medCost("Thousand") :- accident("None"), age("Adult"), cushioning("Excellent").
medCost("Thousand") :- accident("None"), age("Senior"), cushioning("Poor").
medCost("Thousand") :- accident("None"), age("Senior"), cushioning("Fair").
medCost("Thousand") :- accident("None"), age("Senior"), cushioning("Good").
medCost("Thousand") :- accident("None"), age("Senior"), cushioning("Excellent").
...
thisCarDam("None") :- accident("None"), ruggedAuto("EggShell").
thisCarDam("None") :- accident("None"), ruggedAuto("Football").
thisCarDam("None") :- accident("None"), ruggedAuto("Tank").
...
thisCarCost("Thousand") :- thisCarDam("None"), carValue("FiveThou"), \+theft.
0.05::thisCarCost("Thousand"); 0.95::thisCarCost("TenThou") :- thisCarDam("None"), carValue("TenThou"), theft.
thisCarCost("Thousand") :- thisCarDam("None"), carValue("TenThou"), \+theft.
0.04::thisCarCost("Thousand"); 0.01::thisCarCost("TenThou"); 0.95::thisCarCost("HundredThou") :- thisCarDam("None"), carValue("TwentyThou"), theft.
thisCarCost("Thousand") :- thisCarDam("None"), carValue("TwentyThou"), \+theft.
0.04::thisCarCost("Thousand"); 0.01::thisCarCost("TenThou"); 0.95::thisCarCost("HundredThou") :- thisCarDam("None"), carValue("FiftyThou"), theft.
thisCarCost("Thousand") :- thisCarDam("None"), carValue("FiftyThou"), \+theft.
...
thisCarCost("Thousand") :- thisCarDam("None"), carValue("Million"), \+theft.
0.15::thisCarCost("Thousand"); 0.85::thisCarCost("TenThou") :- thisCarDam("Mild"), carValue("FiveThou"), theft.
0.95::thisCarCost("Thousand"); 0.05::thisCarCost("TenThou") :- thisCarDam("Mild"), carValue("FiveThou"), \+theft.
0.03::thisCarCost("Thousand"); 0.97::thisCarCost("TenThou") :- thisCarDam("Mild"), carValue("TenThou"), theft.
0.95::thisCarCost("Thousand"); 0.05::thisCarCost("TenThou") :- thisCarDam("Mild"), carValue("TenThou"), \+theft.
0.03::thisCarCost("Thousand"); 0.02::thisCarCost("TenThou"); 0.95::thisCarCost("HundredThou") :- thisCarDam("Mild"), carValue("TwentyThou"), theft.
0.99::thisCarCost("Thousand"); 0.01::thisCarCost("TenThou") :- thisCarDam("Mild"), carValue("TwentyThou"), \+theft.
0.03::thisCarCost("Thousand"); 0.02::thisCarCost("TenThou"); 0.95::thisCarCost("HundredThou") :- thisCarDam("Mild"), carValue("FiftyThou"), theft.
0.99::thisCarCost("Thousand"); 0.01::thisCarCost("TenThou") :- thisCarDam("Mild"), carValue("FiftyThou"), \+theft.
...
0.001::thisCarCost("Thousand"); 0.001::thisCarCost("TenThou"); 0.998::thisCarCost("HundredThou") :- thisCarDam("Moderate"), carValue("TwentyThou"), theft.
...
0.001::thisCarCost("Thousand"); 0.001::thisCarCost("TenThou"); 0.998::thisCarCost("HundredThou") :- thisCarDam("Moderate"), carValue("FiftyThou"), theft.
...
1e-06::thisCarCost("Thousand"); 1e-06::thisCarCost("TenThou"); 0.999998::thisCarCost("HundredThou") :- thisCarDam("Severe"), carValue("TwentyThou"), theft.
...
1e-06::thisCarCost("Thousand"); 1e-06::thisCarCost("TenThou"); 0.999998::thisCarCost("HundredThou") :- thisCarDam("Severe"), carValue("FiftyThou"), theft.
...
propCost("Million") :- otherCarCost("Million"), thisCarCost("Thousand").
propCost("Million") :- otherCarCost("Million"), thisCarCost("TenThou").
propCost("Million") :- otherCarCost("Million"), thisCarCost("HundredThou").
propCost("Million") :- otherCarCost("Million"), thisCarCost("Million").
